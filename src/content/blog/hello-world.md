...
This blog has a [RSS feed](/rss.xml) that you can follow to be notified of the latest posts. You can also follow me on my socials for more updates. I don't have a fixed posting schedule for now - as mentioned in the intro, I will be posting whenever I find something cool to post about. You can find the repo for this blog [here](https://github.com/htgar/personal-website). Have a great day!
